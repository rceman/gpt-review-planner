...
def run(argv,cwd,env=None):
 e=None if env is None else {**__import__('os').environ,**env}
 p=subprocess.run(argv,cwd=cwd,env=e,text=True,stdout=subprocess.PIPE,stderr=subprocess.PIPE)
