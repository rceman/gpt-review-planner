...
class CompletionContractTests(unittest.TestCase):
    ...
    def valid(self, value, **kwargs):
        self.assertEqual(self.validator.validate_value(value, expected_run_id="run-001", expected_task_sha256="a" * 64, gate_count=2, acceptance_count=2, **kwargs), [])
    ...
    def test_explicit_identity_and_count_arguments_are_authoritative(self):
        ...
        self.assertTrue(self.validator.validate_value(value, expected_run_id="run-001", expected_task_sha256="b" * 64, gate_count=2, acceptance_count=2))
