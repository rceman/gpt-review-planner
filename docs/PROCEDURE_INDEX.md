...
| PROC-PUBLICATION | integrated release task | GPT/Local agent | [publication contract](RELEASE_PUBLICATION.md) and [project integration](PROJECT_INTEGRATION.md) | [release prompt](../prompts/AGENT_RELEASE_VERSION.md) | declaration, release-config, four canonical scripts, workflow identity | validated/tagged/published/not-applicable/blocked | owner report or separate release close |
