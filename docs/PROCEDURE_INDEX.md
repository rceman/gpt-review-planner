...
| PROC-PACK | scope locked | GPT | [patch-pack format](PATCH_PACK_FORMAT.md) and [handoff](PATCH_PACK_HANDOFF.md) | [create pack](../prompts/GPT_CREATE_PATCH_PACK.md) | locked scope | pack-ready/blocked | agent implementation |
